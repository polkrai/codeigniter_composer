...
server('prod', '192.168.44.14', 22)
    ->user('miracle')
    ->forwardAgent()
    ->stage('production')
    ->env('branch', 'master')
    ->env('deploy_path', '/home/miracle/public_html/codeigniter_composer');

// Your Git repository
set('repository', 'git@github.com:polkrai/codeigniter_composer.git');
